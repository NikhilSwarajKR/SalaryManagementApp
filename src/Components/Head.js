        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button sx={{ my: 2, color: 'white', display: 'block' }} onClick={() => navigate('/NonTeaching')}>Non </Button>
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
              <MenuItem>
                <Typography textAlign="center"onClick={() => navigate('/Upload')}>Upload File</Typography>
              </MenuItem>
              <MenuItem>
